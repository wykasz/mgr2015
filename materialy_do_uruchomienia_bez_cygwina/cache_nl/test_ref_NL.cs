...
using nianio;
namespace nianio { 
public class test_ref_NL {

public static Imm NL_SINGLETON_test() {

Dictionary<String, Imm> __function_map;
//line 10
test_ref_NL.NL_test2();

//line 11
test_ref_NL.NL_total_test();
...
public static Imm NL_SINGLETON_test2() {

Dictionary<String, Imm> __function_map;
//line 14
if(true) return null;
}
private static Imm value__singleton__NL_SINGLETON_test2 = null;
public static Imm NL_test2() {
	if (value__singleton__NL_SINGLETON_test2 == null) {
		value__singleton__NL_SINGLETON_test2 = NL_SINGLETON_test2();
	}
	return value__singleton__NL_SINGLETON_test2;
}
public static Imm NL_test3(ImmRef ___arg__0, Imm ___arg__1, ImmRef ___arg__2, Imm ___arg__3, ImmRef ___arg__4, Imm ___arg__5) {
Imm ___nl__0 = ___arg__0.getValue().clone();Imm ___nl__1 = ___arg__1.clone();Imm ___nl__2 = ___arg__2.getValue().clone();Imm ___nl__3 = ___arg__3.clone();Imm ___nl__4 = ___arg__4.getValue().clone();Imm ___nl__5 = ___arg__5.clone();
Imm ___nl__6 = null;
Imm ___nl__7 = null;
Imm ___nl__8 = null;
...
___nl__6 = null;
//line 22
___nl__6 = new ImmDouble(5).clone();
//line 22
...
___nl__6 = null;
//line 24
___arg__0.setValue(___nl__0);___arg__2.setValue(___nl__2);___arg__4.setValue(___nl__4);if(true) return ___nl__7;
//line 24
___nl__7 = null;
//line 25
...
___nl__7 = null;
//line 27
___arg__0.setValue(___nl__0);___arg__2.setValue(___nl__2);___arg__4.setValue(___nl__4);if(true) return ___nl__8;
//line 27
___nl__8 = null;
//line 28
...
___nl__5 = null;
//line 30
___arg__0.setValue(___nl__0);___arg__2.setValue(___nl__2);___arg__4.setValue(___nl__4);if(true) return null;
}

private static Imm NL_test22_priv(ImmRef ___arg__0, ImmRef ___arg__1) {
...
public static Imm NL_SINGLETON_total_test() {
...
//line 43
___nl__3 = new ImmArray(new Imm[] {___nl__4,___nl__5,___nl__6,___nl__7,}).clone();
//line 43
___nl__4 = null;
//line 43
___nl__5 = null;
...
//line 46
___nl__6 = new ImmString("a").clone();
//line 46
___nl__6 = c_rt_lib_NL.NL_get_ref_hash(___nl__1,___nl__6).clone();

//line 46
___nl__8 = new ImmDouble(4).clone();
//line 46
___nl__7 = c_rt_lib_NL.NL_get_ref_arr(___nl__6,___nl__8).clone();

//line 46
__function_map = new Dictionary<String, Imm>();
__function_map.Add("module",new ImmString("test_ref_NL"));
__function_map.Add("name",new ImmString("test2"));
...
___nl__4 = test_ref_NL.NL_test3(___ref______nl__0,___nl__5,___ref______nl__7,___nl__2,___ref______nl__3,___nl__9).clone();
...
c_rt_lib_NL.NL_set_ref_arr(___ref______nl__6,___nl__8,___nl__7);
___nl__6 = ___ref______nl__6.getValue().clone();

//line 46
___nl__9 = new ImmString("a").clone();
//line 46
___ref______nl__1 = new ImmRef(___nl__1);
c_rt_lib_NL.NL_set_ref_hash(___ref______nl__1,___nl__9,___nl__6);
...
___nl__4 = new ImmDouble(1).clone();
//line 47
nassert_NL.NL_a(___nl__0,___nl__4);

//line 47
___nl__4 = null;
//line 48
___nl__4 = ((ImmHash)___nl__1).getHashValue()["a"].clone();
//line 48
...
___nl__4 = ((ImmHash)___nl__1).getHashValue()["a"].clone();
//line 49
___nl__5 = new ImmDouble(4).clone();
//line 49
___nl__4 = (___nl__4 as ImmArray).getArrayValue()[(int)((ImmDouble)___nl__5).getDoubleValue()].clone();
//line 49
___nl__5 = null;
...
//line 50
nassert_NL.NL_a(___nl__2,___nl__4);

//line 50
___nl__4 = null;
//line 51
___nl__5 = new ImmDouble(5).clone();
//line 51
...
___ref______nl__4 = new ImmRef(___nl__4);
test_ref_NL.NL_test22_priv(___ref______nl__5,___ref______nl__4);
...
___nl__5 = null;
//line 54
___nl__5 = new ImmDouble(20).clone();
//line 54
nassert_NL.NL_a(___nl__4,___nl__5);
...
___nl__5 = null;
//line 55
___nl__5 = c_rt_lib_NL.NL_ov_mk_none(new ImmString("wariant")).clone();
//line 56
___nl__7 = c_rt_lib_NL.NL_ov_mk_none(new ImmString("wariant2")).clone();
//line 56
___nl__6 = enum_NL.NL_eq(___nl__5,___nl__7).clone();
...
label_3:
//line 63
___nl__7 = c_rt_lib_NL.NL_ov_mk_none(new ImmString("wariant1")).clone();
//line 63
___nl__6 = enum_NL.NL_eq(___nl__5,___nl__7).clone();
...
private static Imm value__singleton__NL_SINGLETON_total_test = null;
public static Imm NL_total_test() {
	if (value__singleton__NL_SINGLETON_total_test == null) {
		value__singleton__NL_SINGLETON_total_test = NL_SINGLETON_total_test();
	}
	return value__singleton__NL_SINGLETON_total_test;
}
}
}