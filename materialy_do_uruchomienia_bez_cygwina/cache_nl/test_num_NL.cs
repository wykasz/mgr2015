...
___nl__1 = null;
//line 10
___nl__1 = new ImmDouble(65535);
//line 11
___nl__2 = new ImmDouble(65535);
//line 11
...
___nl__2 = null;
//line 12
___nl__2 = new ImmDouble(16775922);
//line 13
___nl__3 = new ImmDouble(16775922);
//line 13
...
___nl__3 = null;
//line 14
___nl__3 = new ImmDouble(2633);
//line 15
___nl__4 = new ImmDouble(24.44);
//line 16
___nl__5 = new ImmDouble(24.44);
//line 16
...
___nl__5 = null;
//line 17
___nl__5 = new ImmDouble(0.15);
//line 18
___nl__6 = new ImmDouble(0.35);
//line 19
___nl__7 = new ImmDouble(0.35);
//line 19
...
//line 26
___nl__10 = new ImmDouble((Double.Parse(___nl__7.getValue().ToString()))+(Double.Parse(___nl__4.getValue().ToString())));
//line 26
___nl__10 = new ImmDouble((Double.Parse(___nl__10.getValue().ToString()))+(Double.Parse(___nl__2.getValue().ToString())));
//line 26
___nl__11 = new ImmDouble(-16424242.2351145);
//line 26
...
___nl__10 = null;
//line 27
___nl__10 = new ImmDouble(351449.8548855);
//line 27
___nl__10 = new ImmDouble((Double.Parse(___nl__9.getValue().ToString()))-(Double.Parse(___nl__10.getValue().ToString())));
//line 27
___nl__0 = ___nl__10;
//line 27
___nl__10 = null;
//line 28
___nl__10 = new ImmDouble(0.001);
//line 28
___nl__10 = c_rt_lib_NL.NL_native_to_nl((Double.Parse(___nl__0.getValue().ToString()))>(Double.Parse(___nl__10.getValue().ToString())) );
//line 28
if (c_rt_lib_NL.NL_check_true_native(___nl__10)) {if (true) {goto label_3;}}
//line 28
___nl__10 = new ImmDouble(0.001);
//line 28
___nl__10 = new ImmDouble(-((ImmDouble)___nl__10).getDoubleValue());
//line 28
___nl__10 = c_rt_lib_NL.NL_native_to_nl((Double.Parse(___nl__0.getValue().ToString()))<(Double.Parse(___nl__10.getValue().ToString())) );
//line 28
label_3:
