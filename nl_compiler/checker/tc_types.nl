...
def get_binary_ops() : ptd::hash(@tc_types::bin_op_type) {
	...
	op_def(ref ret, '*', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '/', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '%', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '+', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '-', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	...
	op_def(ref ret, '<<', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '>>', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '>=', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, 'lt', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, 'gt', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, 'le', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, 'ge', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, '<=', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, '<', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, '>', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, '==', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, '!=', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, '<=>', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, 'eq', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, 'ne', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, 'cmp', tct::tct_sim(), tct::tct_sim(), tct::tct_bool());
	op_def(ref ret, '&', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '|', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '^', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '&&', tct::tct_bool(), tct::tct_bool(), tct::tct_bool());
	op_def(ref ret, '||', tct::tct_bool(), tct::tct_bool(), tct::tct_bool());
	op_def(ref ret, '+=', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '/=', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
	op_def(ref ret, '*=', tct::tct_sim(), tct::tct_sim(), tct::tct_sim());
...
def tc_types::errors_t() {
	return ptd::rec({
			...
			module => ptd::sim(),
			warnings => @tc_types::check_errors_t,
			errors => @tc_types::check_errors_t
		});
}
...
def tc_types::modules_t() {
	return ptd::rec({
			imports => ptd::hash(@boolean_t::type),
			env => @tc_types::env,
			funs => @tc_types::defs_funs_t
		});
}
...
def tc_types::deref_types() {
	return ptd::rec({
			delete => ptd::arr(@tc_types::deref_type),
			create => ptd::arr(@tc_types::deref_type)
		});
}
def tc_types::env() {
	return ptd::rec({
...
def tc_types::check_error_t() {
	return ptd::rec({msg => ptd::sim(), line => ptd::sim(), module => ptd::sim()});
}

def tc_types::check_errors_t() {
	return ptd::arr(@tc_types::check_error_t);
}
def tc_types::type(){
...
def tc_types::lval_path(){
	return ptd::arr(ptd::var({var => ptd::sim(), arr => ptd::none(), rec => ptd::sim()}));
}
...
def tc_types::special_functions() {
	return ptd::hash(ptd::rec({
		r=>@tct::meta_type,
		a=>ptd::arr(@tc_types::fun_arg_t)
	}));
}
